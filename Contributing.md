# Contributing to LeafDoc

We appreciate your interest in contributing to LeafDoc! This document outlines the steps and guidelines for contributing to this project. By following these steps, you can ensure your contribution is smoothly integrated into the project.
...
1. Navigate to the [LeafDoc GitHub repository](https://github.com/tejasnayak1/LeafDoc).
...
```bash
  git clone https://github.com/YOUR_USERNAME/LeafDoc.git
```
